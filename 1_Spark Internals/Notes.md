...
- Google's came up with GFS(Google File System), GMR (Google MapReduce) paper (published in 2004) and this lead to development of Hadoop at Yahoo! in the mid-2000s marked the beginning of a shift towards distributed data processing and storage.
